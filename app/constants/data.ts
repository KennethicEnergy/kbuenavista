...
Delivers proposals and guides customers through the application process without the need for face-to-face interaction.`,
    ...
    projectName: "Game99",
    projectDescription: `Game99 is a multi-platform application built with Next.js and React. It is a platform where users can bet on different games and win real money.`,
    projectTechStack: [
      'NextJs',
      'React',
      'TypeScript',
